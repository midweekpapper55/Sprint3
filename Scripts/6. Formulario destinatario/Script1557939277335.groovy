...
Mobile.waitForElementPresent(findTestObject('DATOS ENVIO/Liquidar - Siguiente'), 50)

Mobile.tap(findTestObject('DATOS ENVIO/Liquidar - Siguiente'), 50)
...
Mobile.setText(findTestObject('DATOS ENVIO/Nmero de documento'), '1234567890', 50)
...
Mobile.waitForElementPresent(findTestObject('Datos Remitente/Nombre Remitente'), 50)

Mobile.setText(findTestObject('Datos Remitente/Nombre Remitente'), 'Angelo Miguel', 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Apellidos Remitente'), 50)

Mobile.setText(findTestObject('Datos Remitente/Apellidos Remitente'), 'Pineda Mendoza', 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Tipo de persona'), 50)

Mobile.tap(findTestObject('Datos Remitente/Tipo de persona'), 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/1 Persona natural'), 50)
...
Mobile.tap(findTestObject('Datos Remitente/Regimen'), 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/1 Comun'), 50)

Mobile.tap(findTestObject('Datos Remitente/1 Comun'), 50)

Mobile.scrollToText('Código postal', FailureHandling.OPTIONAL)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Direccin'), 50)

Mobile.setText(findTestObject('Datos Remitente/Direccin'), 'KR 6B # 113 - 51', 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Telefono'), 0)

Mobile.setText(findTestObject('Datos Remitente/Telefono'), '7850125', 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Email-'), 50)

Mobile.setText(findTestObject('Datos Remitente/Email-'), 'angel201450@hotmail.com', 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Codigo postal'), 50)

Mobile.tap(findTestObject('Datos Remitente/Codigo postal'), 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/DR SIGUIENTE'), 50)

Mobile.tap(findTestObject('Datos Remitente/DR SIGUIENTE'), 50)

Mobile.waitForElementPresent(findTestObject('Datos Remitente/Confirmacin Aceptar'), 50)
